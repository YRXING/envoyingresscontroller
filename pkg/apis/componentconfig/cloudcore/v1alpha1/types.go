...
type Modules struct {
	...
	// EnvoyIngressController indicates envoy ingress controller module config
	EnvoyIngressController *EnvoyIngressController `json:"envoyingressController,omitempty"`
}
